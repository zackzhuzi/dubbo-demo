...
<html>
<head>
<title>用户登录-易生信贷运营后台</title>
<meta name="keywords" content="易生信贷">
<meta name="description" content="易生信贷">
...
<body onkeydown="enterlogin();">
	...
	<div style="text-align: center;">
		<p>
			<a href="http://www.easylife888.com/SmallCredit/testUser.do"
				target="_blank">易生信贷</a>

			<script type="text/javascript">
				var cnzz_protocol = (("https:" == document.location.protocol) ? " https://"
						: " http://");
				document
						.write(unescape("%3Cspan id='cnzz_stat_icon_1256912241'%3E%3C/span%3E%3Cscript src='"
								+ cnzz_protocol
								+ "s4.cnzz.com/stat.php%3Fid%3D1256912241%26show%3Dpic1' type='text/javascript'%3E%3C/script%3E"));
			</script>
		</p>
	</div>
</body>
