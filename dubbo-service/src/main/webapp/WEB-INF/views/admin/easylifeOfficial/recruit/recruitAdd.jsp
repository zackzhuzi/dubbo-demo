...
<script type="text/javascript">
	$(function() {
		$('#recruitAddForm').form({
			url : '${path}/easylifeOfficial/recruit/add',
			onSubmit : function() {
				progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false"
		...
		<form id="recruitAddForm" method="post">
			<table class="grid">
				<tr>
					<td>岗位名称</td>
					...
					<td><select id="recruitType" name="recruitType"
						...
						data-options="width:140,height:25,editable:false,panelHeight:'auto'">
							...
							<option value="2" selected>社会招聘</option>
				...
				<tr>
					...
					<td>
						<!-- 加载编辑器的容器 --> <textArea id="jobResponsibility"
							name="jobResponsibility" style="width: 100%; height: 100%;"></textArea>
					</td>
				</tr>
				<tr>
					<td>职位要求</td>
					<td>
						<!-- 加载编辑器的容器 --> <textArea id="jobRequirement"
							name='jobRequirement' style="width: 100%; height: 100%;"></textArea>
					</td>
				</tr>
			</table>
		</form>
