...
<div style="padding: 3px;">
	<form id="departmentAddForm" method="post">
		<table class="grid">
			<tr>
				<td>部门名称</td>
				<td><input name="name" type="text" placeholder="请输入部门名称"
			...
			<tr>
				<td>简介</td>
				<td colspan="5"><input name="description" style="width: 300px;" /></td>
			</tr>
			<tr>
				<td>上级部门</td>
				<td colspan="3"><select id="departmentAddPid" name="pid"
